...
- Create Angular project with ng: `ng new tasteitinyourhome.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`tasteitinyourhome.client.esproj`).
